...
> 状态：`Proposed / Mixed historical roadmap`  
> 本文保留当时的参数扩展、分期和未落地信号设计，不代表所有字段已经存在。当前实现见
> [`ai_score_parameters.md`](../../design/battle/ai_score_parameters.md)，模拟/调参说明见
> [`balance_simulation.md`](../../design/battle/balance_simulation.md)，架构边界见
> [`project_context_units.md`](../../design/project_context_units.md)。
