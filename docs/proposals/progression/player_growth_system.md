...
当前实现边界以 [`project_context_units.md`](../../design/project_context_units.md) 为准；本文记录玩家成长、职业技能、成就与奖励归并的设计口径。

关联文档：
- [achievement_system_plan.md](../../archive/design/achievement_system_plan.md)
- [战斗统计与成就接入子规格](../../archive/design/achievement_system_plan.md)
- [equipment_system.md](../inventory/equipment_system.md)
- [playable_vertical_slice_roadmap.md](../../archive/design/playable_vertical_slice_roadmap.md)
...
- 装备不应影响：
  ...
  - 成就进度
  - 基础属性永久值
- 装备相关细则继续以 [equipment_system.md](../inventory/equipment_system.md) 为准，但总体上归属于成长系统的“外部构筑层”。
...
- 与总成长系统的关系：
  ...
  - 战斗统计型成就继续按 [成就系统归档中的战斗统计子规格](../../archive/design/achievement_system_plan.md) 扩展，不在这份总纲里重复定义细节。
...
- 设计约束：
  - 战斗中默认不允许换装
  - 卸装后失去授予收益，不保留永久学习痕迹
  - 细则见 [equipment_system.md](../inventory/equipment_system.md)
...
- 输入 A：战斗成就与战斗表现
  - 来源优先复用 [成就系统归档中的战斗统计子规格](../../archive/design/achievement_system_plan.md) 的战斗统计真源。
  - 典型输入：
    - `total_damage_done`
    - `total_kill_count`
