...
Expected initial failure: `graded_save_execute` is unsupported and formal resource is absent.
...
Expected after implementation: schema runner still fails only at missing formal resource until Task 5 creates it; build passes.
