...
经过正式资源和聚焦回归落地的单件武器设计记录放在 [`implemented/`](implemented/README.md)。这些记录解释内容意图，通用运行时合同仍以 [`../../design/battle/equipment_ability_runtime.md`](../../design/battle/equipment_ability_runtime.md) 为准。
