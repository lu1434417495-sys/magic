...
> 状态：`Planned / Not Implemented`。本文是待制作内容清单，不代表当前运行时、数据或任务链已经落地。

> 把 `docs/content/quests/quest_mechanics_full_200.md` 第一部分的阵营人物细化到可直接落进 Godot `.tres` 配置的程度。本文档只覆盖 **Q101–Q125 帝国战争十轮战役** 中出现的人物与兵种身份。
