...
当前实现边界以 [`project_context_units.md`](../../../design/project_context_units.md) 为准；本文记录灰烬交界技能内容策划，不替代技能资源、奖励队列或战斗规则真相源。

说明：
- 本文档收敛 [world_map.md](world_map.md) 中提到的 12 个黑魂风格技能。
