...
- 战斗命中走 `BattleHitResolver`（BAB + 降序 AC + d20，deterministic），详见 `docs/proposals/battle/skill_runtime_expansion.md`。
...
- 战斗命中模型已切到 BAB + 降序 AC + d20（见 `docs/proposals/battle/skill_runtime_expansion.md`），经济闭环的数值校准基于此口径。
