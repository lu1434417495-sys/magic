...
原方案总入口见 [system_expansion.md](../../../proposals/battle/equipment_ability/system_expansion.md)。技能入口迁移见 [battle_skill_availability_migration.md](battle_skill_availability_migration.md)。
