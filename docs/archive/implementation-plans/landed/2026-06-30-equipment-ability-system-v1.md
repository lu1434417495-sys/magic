...
**Goal:** Land the V1 equipment ability framework described by `docs/proposals/battle/equipment_ability/system_expansion.md` in reviewable slices, while keeping current battle commands, save writeback, AI, and content validation stable at every step.
...
1. `docs/archive/implementation-plans/equipment_ability/battle_skill_availability_migration.md` resolves `SkillEntryId` first-class migration, including command identity, selection state, preview, execution, HUD, AI, and scoped auto-cast source rules.
2. `docs/archive/implementation-plans/equipment_ability/equipment_durability_selector_commit.md` resolves equipment durability selector / selected-target commit split, including old spell effect parity, selected target revalidation, no second random roll, and writeback boundaries.
...
- `docs/proposals/battle/equipment_ability/system_expansion.md`
- `docs/archive/implementation-plans/equipment_ability/battle_skill_availability_migration.md`
- `docs/archive/implementation-plans/equipment_ability/equipment_durability_selector_commit.md`
...
- The framework does not require converting every file under `docs/content/weapons/by_family` before merge.
