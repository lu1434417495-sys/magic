...
本文件是 [`2026-06-18-character-trait-system-plan.md`](2026-06-18-character-trait-system-plan.md) 的实现细则，给出可直接落码的类型、方法体、映射表、roll 算法、序列化与校验逻辑。架构边界、分期与非目标见主计划。本文件遵循主计划「决策冻结」一节的约束。
