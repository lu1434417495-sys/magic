...
- `data/configs/items_templates/weapon_type_*_base.tres`
  - 当前覆盖 `docs/design/weapon_types_damage.md` 中的 31 类 BG3 基础 weapon type。
...
- `docs/design/weapon_types_damage.md`
- `docs/design/equipment_system_plan.md`
- `docs/design/warehouse_equipment_consensus_solution_2026-05-11.md`
