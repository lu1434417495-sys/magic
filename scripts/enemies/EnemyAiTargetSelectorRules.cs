...
public partial class EnemyAiTargetSelectorRules : RefCounted
{
	...
	public static GDictionary ANY_TARGET_SELECTORS() => new()
	{
		[NearestEnemy] = true,
		[LowestHpEnemy] = true,
	...
	public static GDictionary ENEMY_TARGET_SELECTORS() => new()
	{
		[NearestEnemy] = true,
		[LowestHpEnemy] = true,
		[NearestRoleThreatEnemy] = true,
	...
	)
	{
		...
		if (!supportedSelectors.ContainsKey(selectorKey) || (allowed.Count > 0 && !allowed.ContainsKey(selectorKey)))
