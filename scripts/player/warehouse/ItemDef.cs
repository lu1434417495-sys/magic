...
public partial class ItemDef : Resource
{
    ...
    {
        return new Godot.Collections.Array<StringName> { ItemCategoryMisc, ItemCategoryEquipment, ItemCategorySkillBook };
    }

    [Export] public StringName item_id = "";
    [Export] public StringName base_item_id = "";
    [Export] public string display_name = "";
    [Export(PropertyHint.MultilineText)] public string description = "";
    [Export] public string icon = "";
    [Export] public bool is_stackable = true;
    [Export(PropertyHint.Range, "0,999999,1")] public int base_price;
    [Export(PropertyHint.Range, "0,999999,1")] public int buy_price;
    [Export(PropertyHint.Range, "0,999999,1")] public int sell_price;
    [Export] public bool sellable = true;
    [Export(PropertyHint.Range, "1,9999,1")] public int max_stack = 99;
    [Export] public StringName item_category = "";
    [Export] public Godot.Collections.Array<StringName> tags = new();
    [Export] public Godot.Collections.Array<StringName> crafting_groups = new();
    [Export] public Godot.Collections.Array<StringName> quest_groups = new();
    [Export] public Godot.Collections.Array<string> equipment_slot_ids = new();
    [Export] public Godot.Collections.Array<AttributeModifier> attribute_modifiers = new();
    [Export] public StringName granted_skill_id = "";
    [Export] public Godot.Collections.Array<string> occupied_slot_ids = new();
    [Export] public Resource equip_requirement;
    [Export] public StringName equipment_type_id = "";
    [Export] public Resource weapon_profile;
    [Export(PropertyHint.Range, "-1,20,1")] public int max_dex_bonus = -1;
    ...
    public Godot.Collections.Array<StringName> get_crafting_groups() => NormalizeStringNameList(crafting_groups);
    public Godot.Collections.Array<StringName> get_quest_groups() => NormalizeStringNameList(quest_groups);
    ...
    {
        return EquipmentRules.normalize_slot_ids(Variant.From(equipment_slot_ids));
    }
    ...
    {
        return has_equipment_category() && get_equipment_type_id_normalized() == EquipmentTypeWeapon;
    }
    ...
    public int get_weapon_attack_range()
    {
        ...
        if (!is_weapon() || profile == null)
            return 0;
        return Mathf.Max(profile.Get("attack_range").AsInt32(), 0);
    }
    ...
    {
        return has_equipment_category() && get_equipment_type_id_normalized() == EquipmentTypeAccessory;
    }
    ...
    {
        return new Godot.Collections.Array<StringName> { EquipmentTypeWeapon, EquipmentTypeArmor, EquipmentTypeAccessory };
    }

    public static Godot.Collections.Array<StringName> get_valid_weapon_physical_damage_tags()
    {
        return new Godot.Collections.Array<StringName> { DamageTagPhysicalSlash, DamageTagPhysicalPierce, DamageTagPhysicalBlunt };
    }
    ...
    public Godot.Collections.Array<StringName> get_final_occupied_slot_ids(StringName entry_slot_id)
    {
        if (occupied_slot_ids.Count > 0)
            return EquipmentRules.normalize_slot_ids(Variant.From(occupied_slot_ids));
    ...
    private static Godot.Collections.Array<StringName> NormalizeStringNameList(Godot.Collections.Array<StringName> values)
    {
    ...
    private Resource _get_weapon_profile_resource()
    {
    ...
    private static int ApplyPriceBasisPoints(int price, int priceBasisPoints)
    {
        ...
        return (normalizedPrice * normalizedBasisPoints + PriceBasisPointsDenominator / 2) / PriceBasisPointsDenominator;
    }
}
