...
public partial class CombatSkillTargetingContentRules : RefCounted
{
    ...
    private static readonly Godot.Collections.Dictionary VALID_CAST_VARIANT_TARGET_MODES = new()
    {
        { TARGET_MODE_UNIT, true },
        { TARGET_MODE_GROUND, true },
    };
    ...
    public static bool is_valid_combat_target_mode(Variant value)
    {
        return VALID_COMBAT_TARGET_MODES.ContainsKey(_normalize_string_name(value));
    }

    public static bool is_valid_cast_variant_target_mode(Variant value)
    {
        return VALID_CAST_VARIANT_TARGET_MODES.ContainsKey(_normalize_string_name(value));
    }

    public static bool is_valid_target_selection_mode(Variant value)
    {
        return VALID_TARGET_SELECTION_MODES.ContainsKey(_normalize_string_name(value));
    }

    public static bool is_valid_selection_order_mode(Variant value)
    {
        return VALID_SELECTION_ORDER_MODES.ContainsKey(_normalize_string_name(value));
    }

    public static bool is_valid_area_pattern(Variant value)
    {
        return VALID_AREA_PATTERNS.ContainsKey(_normalize_string_name(value));
    }

    public static bool is_valid_footprint_pattern(Variant value)
    {
        return VALID_FOOTPRINT_PATTERNS.ContainsKey(_normalize_string_name(value));
    }
    ...
    private static StringName _normalize_string_name(Variant value)
    {
