...
public partial class TagRequirement : Resource
{
    ...
    [Export] public StringName tag = "";
    [Export] public int count = 1;
    [Export] public StringName skill_state = SkillStateCoreMax;
    [Export] public StringName origin_filter = OriginFilterAny;
    [Export] public StringName selection_role = SelectionRoleAssignedCore;
    ...
    {
        return skill_state == SkillStateLearned || skill_state == SkillStateCore || skill_state == SkillStateCoreMax
            ? skill_state
            : SkillStateCoreMax;
    }
    ...
    {
        return origin_filter == OriginFilterAny || origin_filter == OriginFilterUnmergedOnly || origin_filter == OriginFilterMergedOnly
            ? origin_filter
            : OriginFilterAny;
    }
    ...
    {
        return selection_role == SelectionRoleQualifier || selection_role == SelectionRoleAssignedCore
            ? selection_role
