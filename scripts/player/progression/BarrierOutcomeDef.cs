...
{
    [Export] public StringName outcome_type = "";
    [Export] public int amount = 0;
    [Export] public StringName damage_tag = "";
    [Export] public bool half_on_success = false;
    [Export] public int success_amount = 0;
    [Export] public StringName success_damage_tag = "";
    [Export] public int fatal_damage = 99999;
    [Export] public StringName status_id = "";
    [Export] public StringName save_ability = "";
    [Export] public StringName save_tag = "";
    [Export] public int save_dc = 0;
    [Export] public Dictionary @params = new();
