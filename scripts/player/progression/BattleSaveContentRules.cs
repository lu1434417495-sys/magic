...
public partial class BattleSaveContentRules : RefCounted
{
    ...
    {
        { SAVE_TAG_SLEEP, true }, { SAVE_TAG_PARALYSIS, true }, { SAVE_TAG_CHARM, true },
        { SAVE_TAG_POISON, true }, { SAVE_TAG_DRAGON_BREATH, true }, { SAVE_TAG_FIREBALL, true },
        { SAVE_TAG_CHAIN_LIGHTNING, true }, { SAVE_TAG_EQUIPMENT_DISJUNCTION, true }, { SAVE_TAG_MAGIC, true },
        { SAVE_TAG_ILLUSION, true }, { SAVE_TAG_FRIGHTENED, true }, { SAVE_TAG_EXECUTE, true },
        { SAVE_TAG_STRENGTH, true }, { SAVE_TAG_AGILITY, true }, { SAVE_TAG_CONSTITUTION, true },
        { SAVE_TAG_PERCEPTION, true }, { SAVE_TAG_INTELLIGENCE, true }, { SAVE_TAG_WILLPOWER, true },
    };

    private static readonly Godot.Collections.Dictionary VALID_SAVE_ABILITIES = new()
    {
        { UnitBaseAttributes.STRENGTH(), true }, { UnitBaseAttributes.AGILITY(), true }, { UnitBaseAttributes.CONSTITUTION(), true },
        { UnitBaseAttributes.PERCEPTION(), true }, { UnitBaseAttributes.INTELLIGENCE(), true }, { UnitBaseAttributes.WILLPOWER(), true },
    };

    private static readonly Godot.Collections.Dictionary CONTROL_SAVE_TAGS = new()
    {
        { SAVE_TAG_SLEEP, true }, { SAVE_TAG_PARALYSIS, true }, { SAVE_TAG_CHARM, true },
        { SAVE_TAG_ILLUSION, true }, { SAVE_TAG_FRIGHTENED, true },
    };

    private static readonly Godot.Collections.Dictionary VALID_SAVE_DC_MODES = new()
    {
        { SAVE_DC_MODE_STATIC, true }, { SAVE_DC_MODE_CASTER_SPELL, true },
    };
}
