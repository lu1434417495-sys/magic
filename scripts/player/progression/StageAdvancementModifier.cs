...
public partial class StageAdvancementModifier : Resource
{
    ...
    [Export] public StringName modifier_id = "";
    [Export] public string display_name = "";
    [Export] public StringName target_axis = TargetAxisFull;
    [Export] public int stage_offset = 1;
    [Export] public StringName max_stage_id = "";
    [Export] public Godot.Collections.Array<StringName> applies_to_race_ids = new();
    [Export] public Godot.Collections.Array<StringName> applies_to_subrace_ids = new();
    [Export] public Godot.Collections.Array<StringName> applies_to_bloodline_ids = new();
    [Export] public Godot.Collections.Array<StringName> applies_to_ascension_ids = new();
    [Export] public bool grants_attributes = true;
    [Export] public bool grants_traits;
    [Export] public bool grants_body_size_change;
