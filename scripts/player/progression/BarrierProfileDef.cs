...
public partial class BarrierProfileDef : Resource
{
    ...
    [Export] public StringName anchor_mode = "fixed";
    [Export] public StringName area_pattern = "diamond";
    [Export] public int radius_cells;
    [Export] public int duration_tu;
    [Export] public bool catch_all_projected_effects;
    [Export] public Godot.Collections.Array<BarrierLayerDef> layers = new();
