...
public partial class AttributeSourceContext : RefCounted
{
    ...
    public GodotObject equipment_state;
    public GodotObject passive_state;
    public GodotObject temporary_effects;
    public Godot.Collections.Array stage_advancement_modifiers = new();

    public void set_effective_age_stage(AgeStageRule rule, StringName sourceType, StringName sourceId)
    {
        if (rule == null)
        {
            age_stage_rule = null;
