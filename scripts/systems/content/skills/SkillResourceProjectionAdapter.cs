...
/// <summary>
/// Test-only Godot Resource projection boundary for synthetic schema fixtures and detached
/// Resource builders. Production skill authoring loads JSON directly and never calls this adapter.
/// </summary>
internal static partial class SkillResourceProjectionAdapter
{
    ...
    internal static ContentImportStageResult<CombatSkillImportModel> TryAdaptCombat(
        JsonContentEntryContext context,
    ...
    )
    {
        ...
        ContentImportStageResult<SkillImportModel> result = TryAdapt(context, root);
    ...
    internal static ContentImportStageResult<CombatEffectImportModel> TryAdaptEffect(
        JsonContentEntryContext context,
    ...
    )
    {
        ...
        ContentImportStageResult<CombatSkillImportModel> result =
            TryAdaptCombat(context, combat, fallbackSkillId);
