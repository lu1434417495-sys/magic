...
public partial class BattleDamageResolver
{
    ...
    internal sealed class EquipmentDurabilitySelectionResult
    {
        ...
        public IReadOnlyList<BattleDamageResolver.EquipmentDurabilitySelectionCandidate> Candidates { get; init; } =
            Array.Empty<BattleDamageResolver.EquipmentDurabilitySelectionCandidate>();
        public int TotalWeight { get; init; }
        public int Roll { get; init; }
        public StringName NoTargetReason { get; init; } = "";

        public static BattleDamageResolver.EquipmentDurabilitySelectionResult NoTarget(StringName reason) =>
            new()
            {
                HasSelection = false,
        ...
        public static BattleDamageResolver.EquipmentDurabilitySelectionResult Selected(
            EquipmentAbilityEquipmentTargetRef target,
            int roll,
            IReadOnlyList<BattleDamageResolver.EquipmentDurabilitySelectionCandidate> candidates = null,
            int totalWeight = 0
        ) =>
            new()
            {
                ...
                Candidates = candidates ?? Array.Empty<BattleDamageResolver.EquipmentDurabilitySelectionCandidate>(),
                TotalWeight = totalWeight,
                Roll = roll,
            };

        public static BattleDamageResolver.EquipmentDurabilitySelectionResult CandidatesOnly(
            IReadOnlyList<BattleDamageResolver.EquipmentDurabilitySelectionCandidate> candidates,
            int totalWeight
        ) =>
            new()
            {
    ...
    ) => _equipmentDurabilityResolver.ApplyEquipmentDurabilityDamageToSelection(request);
    ...
    ) => _equipmentDurabilityResolver.SelectEquipmentForDurabilityDamage(query);
