...
public partial class AscensionTraitResolver : RefCounted
{
    ...
    public static void apply_to_unit(BattleUnitState unitState, PassiveSourceContext context)
    {
        if (unitState == null || context == null)
            return;
        _apply_identity_def_projection(unitState, context.bloodline_def, unitState.bloodline_trait_ids);
        _apply_identity_def_projection(unitState, context.bloodline_stage_def, unitState.bloodline_trait_ids);
        _apply_identity_def_projection(unitState, context.ascension_def, unitState.ascension_trait_ids);
        _apply_identity_def_projection(unitState, context.ascension_stage_def, unitState.ascension_trait_ids);
    }
