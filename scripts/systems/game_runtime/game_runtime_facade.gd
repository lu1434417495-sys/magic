...
const WORLD_MAP_DATA_CONTEXT_SCRIPT = preload("res://scripts/systems/world/world_map_data_context.gd")
...
const PARTY_ITEM_USE_SERVICE_SCRIPT = preload("res://scripts/systems/inventory/party_item_use_service.gd")
...
const GAME_RUNTIME_QUEST_COMMAND_HANDLER_SCRIPT = preload("res://scripts/systems/game_runtime/game_runtime_quest_command_handler.gd")
const GAME_RUNTIME_SNAPSHOT_BUILDER_SCRIPT = preload("res://scripts/systems/game_runtime/game_runtime_snapshot_builder.gd")
const GAME_RUNTIME_COMMAND_LOGGER_SCRIPT = preload("res://scripts/systems/game_runtime/game_runtime_command_logger.gd")
const GAME_RUNTIME_BATTLE_WRITEBACK_SERVICE_SCRIPT = preload("res://scripts/systems/game_runtime/game_runtime_battle_writeback_service.gd")
const GAME_RUNTIME_BATTLE_LOOT_COMMIT_SERVICE_SCRIPT = preload("res://scripts/systems/game_runtime/game_runtime_battle_loot_commit_service.gd")
const GAME_RUNTIME_CHARACTER_INFO_BUILDER_SCRIPT = preload("res://scripts/systems/game_runtime/game_runtime_character_info_builder.gd")
...
var _battle_loot_commit_service = GAME_RUNTIME_BATTLE_LOOT_COMMIT_SERVICE_SCRIPT.new()
var _character_info_builder = GAME_RUNTIME_CHARACTER_INFO_BUILDER_SCRIPT.new()
...
var _quest_command_handler = GAME_RUNTIME_QUEST_COMMAND_HANDLER_SCRIPT.new()
...
func setup(game_session) -> void:
	...
	_battle_loot_commit_service.setup(self)
	_character_info_builder.setup(self)
	...
	_quest_command_handler.setup(self)
...
func dispose() -> void:
	...
	if _command_logger != null:
		_command_logger.dispose()
	if _battle_writeback_service != null:
		_battle_writeback_service.dispose()
	if _battle_loot_commit_service != null:
		_battle_loot_commit_service.dispose()
	if _character_info_builder != null:
	...
	if _quest_command_handler != null:
...
func _bind_runtime_sidecar_owners() -> void:
	if _snapshot_builder != null:
		_snapshot_builder.setup(self)
	if _command_logger != null:
		_command_logger.setup(self)
...
func _commit_battle_local_views_to_party_state(battle_state: BattleState, party_state) -> Dictionary:
	...
	return _battle_writeback_service.commit_battle_local_views_to_party_state(battle_state, party_state)
...
func _report_battle_local_writeback_invariant_failure(
	...
	_bind_runtime_sidecar_owners()
	_battle_writeback_service.report_invariant_failure(writeback_result, battle_summary, winner_faction_id)
...
func _build_battle_resolution_status_message(
	...
	return _battle_loot_commit_service.build_battle_resolution_status_message(battle_name, winner_faction_id, loot_commit_result, persisted_ok)
...
func _build_last_battle_loot_snapshot(
	...
	return _battle_loot_commit_service.build_last_battle_loot_snapshot(battle_name, winner_faction_id, battle_resolution_result, loot_commit_result)


func _format_battle_drop_entries(drop_entry_variants: Array) -> String:
	return _battle_loot_commit_service.format_battle_drop_entries(drop_entry_variants)
...
func command_accept_quest(quest_id: StringName, allow_reaccept: bool = false) -> Dictionary:
	return _execute_logged_command("quest.accept", "quest", {
		...
		return _quest_command_handler.command_accept_quest(quest_id, allow_reaccept)
	)
...
func command_progress_quest(quest_id: StringName, objective_id: StringName, progress_delta: int = 1, payload: Dictionary = {}) -> Dictionary:
	return _execute_logged_command("quest.progress", "quest", {
		...
		return _quest_command_handler.command_progress_quest(quest_id, objective_id, progress_delta, payload)
	)
...
func command_complete_quest(quest_id: StringName) -> Dictionary:
	return _execute_logged_command("quest.complete", "quest", {
		...
		return _quest_command_handler.command_complete_quest(quest_id)
	)
...
func command_submit_quest_item(quest_id: StringName, objective_id: StringName = &"") -> Dictionary:
	return _execute_logged_command("quest.submit_item", "quest", {
		...
		return _quest_command_handler.command_submit_quest_item(quest_id, objective_id)
	)
...
func command_claim_quest(quest_id: StringName) -> Dictionary:
	return _execute_logged_command("quest.claim", "quest", {
		...
		return _quest_command_handler.command_claim_quest(quest_id)
	)
...
func _execute_logged_command(event_id: String, domain: String, context: Dictionary, action: Callable) -> Dictionary:
	return _command_logger.execute_logged_command(event_id, domain, context, action)


func _log_active_command_scope_result(result: Dictionary) -> void:
	_command_logger.log_active_command_scope_result(result)


func _build_runtime_log_state() -> Dictionary:
	return _command_logger.build_runtime_log_state()


func _log_runtime_event(level: String, domain: String, event_id: String, message: String, context: Dictionary = {}) -> void:
	_command_logger.log_runtime_event(level, domain, event_id, message, context)


func _log_battle_batch_entries(batch) -> void:
	_command_logger.log_battle_batch_entries(batch)


func _build_battle_log_state() -> Dictionary:
	return _command_logger.build_battle_log_state()


func _build_battle_batch_log_context(batch) -> Dictionary:
	return _command_logger.build_battle_batch_log_context(batch)


func _normalize_log_variant(value):
	return _command_logger.normalize_log_variant(value)
...
func _build_character_info_meta_label(type_label: String, faction_label: String, coord: Vector2i) -> String:
	return _character_info_builder.build_character_info_meta_label(type_label, faction_label, coord)


func _build_world_character_info_sections(npc: Dictionary, coord: Vector2i, faction_label: String) -> Array[Dictionary]:
	return _character_info_builder.build_world_character_info_sections(npc, coord, faction_label)


func _build_battle_character_info_sections(unit: BattleUnitState, type_label: String, faction_label: String) -> Array[Dictionary]:
	return _character_info_builder.build_battle_character_info_sections(unit, type_label, faction_label)


func _build_battle_character_info_fate_payload(unit: BattleUnitState) -> Dictionary:
	return _character_info_builder.build_battle_character_info_fate_payload(unit)
...
func _build_battle_character_info_base_entries(unit: BattleUnitState, type_label: String, faction_label: String) -> Array[Dictionary]:
	return _character_info_builder.build_battle_character_info_base_entries(unit, type_label, faction_label)


func _build_battle_character_status_entries(unit: BattleUnitState) -> Array[Dictionary]:
	return _character_info_builder.build_battle_character_status_entries(unit)


func _build_battle_character_skill_entries(unit: BattleUnitState) -> Array[Dictionary]:
	return _character_info_builder.build_battle_character_skill_entries(unit)


func _get_battle_unit_attribute_value(unit: BattleUnitState, attribute_id: StringName) -> int:
	return _character_info_builder.get_battle_unit_attribute_value(unit, attribute_id)
...
func _batch_requires_full_battle_refresh(batch) -> bool:
	if batch == null:
		return false
	return (
		batch.phase_changed
...
func _get_equipment_instance_id_allocator() -> Callable:
	if _game_session == null or not _game_session.has_method("allocate_equipment_instance_id"):
		return Callable()
	return Callable(_game_session, "allocate_equipment_instance_id")
