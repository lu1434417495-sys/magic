...
TYPE_LABELS = {
	...
	"ProfessionDefinition": "职业定义",
	"ProfessionPromotionRequirementDefinition": "职业晋升条件",
	"ProfessionRankRequirementDefinition": "职业阶位条件",
	"RecipeDef": "配方定义",
	"RetreatAction": "撤退行动",
...
FIELD_LABELS = {
	...
	"follow_up_damage_multiplier_percent": "追击伤害百分比",
