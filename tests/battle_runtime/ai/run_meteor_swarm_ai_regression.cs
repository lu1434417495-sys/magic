        ...
        try
        {
            ...
            UseGroundSkillActionDefinition action =
                TestEnemyDefinitionFactory.UseGroundSkill(
                    "meteor_friendly_fire_probe",
                    maximumFriendlyFireTargetCount: 99,
            ...
            _test.True(
                ...
                "use_ground_skill 应优先遵守 meteor hard reject，而不是粗略友伤数量。"
            );
        }
        finally
        {
    ...
    private void TestMeteorSwarmFriendlyFireSoftAndProtectedPaths()
    {
        ...
        try
        {
            ...
            if (softScore != null)
            {
                ...
                UseGroundSkillActionDefinition defaultAction =
                    TestEnemyDefinitionFactory.UseGroundSkill("meteor_default_probe");
                _test.True(
                    new BattleAiGroundSkillActionEvaluator().PassesFriendlyFireLimits(
                        defaultAction,
                        softScore
