...
func _build_manual_unit(unit_id: StringName, display_name: String, coord: Vector2i):
	...
	unit.attribute_snapshot.set_value(&"magic_attack", 10)
	unit.attribute_snapshot.set_value(&"physical_defense", 22)
...
func _build_ai_unit(unit_id: StringName, display_name: String, coord: Vector2i):
	...
	unit.attribute_snapshot.set_value(&"magic_attack", 14)
	unit.attribute_snapshot.set_value(&"physical_defense", 16)
	unit.attribute_snapshot.set_value(&"magic_defense", 16)
	unit.attribute_snapshot.set_value(&"speed", 10)
