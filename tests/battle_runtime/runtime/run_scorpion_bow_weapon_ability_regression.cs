...
public partial class run_scorpion_bow_weapon_ability_regression : SceneTree
{
    ...
    public override void _Initialize()
    {
        try
        {
            ...
            Quit(_test.Finish("Scorpion Bow weapon ability regression"));
        }
    ...
    private sealed class ScorpionFixture : IDisposable
    {
        ...
        internal static ScorpionFixture Build(GArray damageRolls)
        {
            ...
            return new ScorpionFixture(itemRegistry, progressionRegistry, partyState, runtime);
        }
