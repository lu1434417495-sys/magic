...
public partial class run_glory_weapon_ability_regression : LifecycleTestSceneTree
{
    ...
    private void Run()
    {
        try
        {
            ...
            RequestTestExit(_test.Finish("Glory weapon ability regression"));
        }
    ...
    private sealed class GloryFixture : IDisposable
    {
        ...
        internal static GloryFixture Build(BattleDamageResolver damageResolver)
        {
            ...
            return new GloryFixture(characterManagement, partyState, runtime, snapshot);
        }
