...
public partial class run_viper_morningstar_weapon_ability_regression : SceneTree
{
    ...
    public override void _Initialize()
    {
        try
        {
            ...
            Quit(_test.Finish("Viper Morningstar weapon ability regression"));
        }
    ...
    private sealed class ViperFixture : IDisposable
    {
        ...
        internal static ViperFixture Build(GArray damageRolls)
        {
            ...
            return new ViperFixture(itemRegistry, progressionRegistry, partyState, runtime);
        }
