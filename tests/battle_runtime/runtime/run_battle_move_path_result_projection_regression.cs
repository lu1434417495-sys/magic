...
public partial class run_battle_move_path_result_projection_regression : LifecycleTestSceneTree
{
    ...
    public override void _Initialize()
    {
        ...
        RequestTestExit(_test.Finish("Battle move path result projection regression"));
    }
